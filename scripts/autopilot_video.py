...
SKILL_FILES = ["content-strategy.md", "manifest-lock-knowledge.md", "tiktok-slideshows.md"]
MEMORY_FILES = ["hook-results.md", "post-performance.md", "failure-log.md"]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--persona", required=True, choices=["sanya", "sophie", "aliyah", "both", "all"],
                        help="sanya=ManifestLock, sophie=JournalLock, aliyah=both apps, both=sanya+sophie, all=everyone")
