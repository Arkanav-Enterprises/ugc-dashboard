...
EXCLUDE_ARGS="--exclude='.env' --exclude='output/' --exclude='logs/' --exclude='__pycache__/' --exclude='.DS_Store' --exclude='frontend/node_modules/' --exclude='frontend/.next/' --exclude='backend/.venv/'"
